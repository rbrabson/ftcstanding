...
func GetTeamAwardsByEvent(eventID string, teamID int) []EventAward {
	stmt := GetStatement("getTeamAwardsByEvent")
	if stmt == nil {
		return nil
	}
...
func GetAllTeamAwards(teamID int) []EventAward {
	stmt := GetStatement("getAllTeamAwards")
	if stmt == nil {
		return nil
	}
...
func GetEventCodesByRegion(regionCode string) []string {
	stmt := GetStatement("getEventCodesByRegion")
	if stmt == nil {
		return nil
	}
...
func GetAdvancementsByRegion(regionCode string) []EventAdvancement {
	stmt := GetStatement("getAdvancementsByRegion")
	if stmt == nil {
		return nil
	}
	rows, err := stmt.Query(regionCode)
...
func GetAllAdvancements() []EventAdvancement {
	stmt := GetStatement("getAllAdvancements")
	if stmt == nil {
		return nil
	}
	rows, err := stmt.Query()
